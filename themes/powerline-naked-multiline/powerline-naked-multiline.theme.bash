...
. "$BASH_IT/themes/powerline-naked-multiline/powerline-naked-multiline.base.bash"

PROMPT_CHAR=${POWERLINE_PROMPT_CHAR:=""}
POWERLINE_LEFT_SEPARATOR=${POWERLINE_LEFT_SEPARATOR:=""}

USER_INFO_SSH_CHAR=${POWERLINE_USER_INFO_SSH_CHAR:=" "}
USER_INFO_THEME_PROMPT_COLOR=67
...
BATTERY_STATUS_THEME_PROMPT_DISPLAY_THRESHOLD=50
BATTERY_STATUS_THEME_PROMPT_LOW_COLOR=166
BATTERY_STATUS_THEME_PROMPT_GOOD_COLOR=185
BATTERY_STATUS_THEME_PROMPT_CRITICAL_COLOR=124
...
POWERLINE_PROMPT=${POWERLINE_PROMPT:="kube user_info scm cwd"}
